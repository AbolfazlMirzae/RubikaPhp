...
class Bot extends Parameters
{
    ...
    public function applyTextFormatting(array $params, ?string $text): array
    {
    ...
    public function sendMessage(): array
    {
        ...
        $data = $this->applyTextFormatting($data, $this->text);
    ...
    public function sendFile(): array
    {
        ...
        // apply text/metadata formatting

        if ($this->message_id) {
            $params['reply_to_message_id'] = $this->message_id;
        }

        $params = $this->applyTextFormatting($params, $this->text);
    ...
    public function editMessageText(): array
    {
        ...
        return $this->api->request("editMessageText", $data);
    }
    ...
    public function banUser(string $chatId, string $userId): array
    {
        return $this->api->request('banChatMember', [
            'chat_id' => $chatId,
            'user_id' => $userId
        ]);
    }

    public function unbanUser(string $chatId, string $userId): array
    {
        return $this->api->request('unbanChatMember', [
            'chat_id' => $chatId,
            'user_id' => $userId
        ]);
    }
